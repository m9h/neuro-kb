...
author:
  - Morgan G Hough
date: "2026-03-20"
keywords: [jax, equinox, hypergraph, graph-neural-networks, topological-deep-learning, geometric-deep-learning, computational-biology]
---
...
Index-based message passing for O(nnz) aggregation via the star expansion.

### incidence_to_star_expansion

::: hgx.incidence_to_star_expansion
...
Conversions between hypergraph and graph representations.

### clique_expansion

::: hgx.clique_expansion

### hypergraph_laplacian

::: hgx.hypergraph_laplacian
