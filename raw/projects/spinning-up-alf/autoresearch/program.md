# spinning-up-alf Autoresearch Program

> Generated by research-infra on 2026-03-20. Customize this file for your project.

## Goal

Validate the RL↔AIF equivalence claims empirically — find environments where the theoretical equivalences break down or where one framework offers practical advantages.
...
```
equivalence_gap = |V_RL(s) - (-G_AIF(s))| averaged over states, plus learning curve comparison (area under reward curve)
```
